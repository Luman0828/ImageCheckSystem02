...
widgSelectBlockOptions.push("", "改变块字体");
widgSelectBlockOptions.push("<h1>", "标题 1");
widgSelectBlockOptions.push("<h2>", "标题 2");
widgSelectBlockOptions.push("<h3>", "标题 3");
widgSelectBlockOptions.push("<h4>", "标题 4");
widgSelectBlockOptions.push("<h5>", "标题 5");
widgSelectBlockOptions.push("<h6>", "标题 6");
widgSelectBlockOptions.push("<p>", "段落");
